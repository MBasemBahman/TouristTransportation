...
namespace DevelopmentDAL.Migrations
{
    ...
    [Migration("20230925135008_add_app_about")]
    partial class addappabout
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.DBModels.DashboardAdministrationModels.DashboardView", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 32,
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "CompanyTripBooking",
                            ViewPath = "CompanyTripBooking"
                        },
                        new
                        {
                            Id = 33,
                            ...
                            ViewPath = "CompanyTripBookingState"
                        },
                        new
                        {
                            Id = 34,
            ...
            modelBuilder.Entity("Entities.DBModels.MainDataModels.AppAbout", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.DBModels.MainDataModels.AppAboutLang", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.DBModels.TripModels.TripLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.DBModels.UserModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Developer",
                            Password = "$2a$11$Q3Km5JyItSY3G.1ZO36Eve.01rKGHTJtHkOm41Ixb9NZ3CDKZ03Xe",
                            UserName = "Developer"
                        });
                });
            ...
            modelBuilder.Entity("Entities.DBModels.MainDataModels.AppAboutLang", b =>
                {
                    b.HasOne("Entities.DBModels.MainDataModels.AppAbout", "Source")
                        .WithMany("AppAboutLangs")
                        .HasForeignKey("Fk_Source")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
