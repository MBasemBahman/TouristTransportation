...
function saveCompanyTrip(data, errDiv) {
    $.ajax({
        url: `/CompanyTripEntity/CompanyTrip/CreateOrEditWizard`,
        method: 'post',
        data: data,
        cache: false,
        contentType: false,
        ...
        success: function (data) {
            ...
            $("input[name=fk_CompanyTrip]").val(data.id);
            nextForm(errDiv);
        },
...
function nextForm(errDiv = $(".company_trip_error_div")) {
    errDiv.html('');
...
$(function () {
    ...
    let myDropzone = new Dropzone("#dpz-multiple-files", {
        ...
        removedfile: function (file) {
            $.ajax({
                url: `/CompanyTripEntity/CompanyTripAttachment/Delete`,
                method: "post",
                data: {id: file.id},
                success: function (data) {
                }
